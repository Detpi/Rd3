...
function traerInformacionMotos(){
    $.ajax({
        url:"http://129.151.112.171:8080/api/Motos/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionMotos(){
    let var3 = {
        ...
        url:"http://129.151.112.171:8080/api/Motos/save",
...
function traerInformacionClientes(){
    $.ajax({
        url:"http://129.151.112.171:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionClientes(){
    let var4 = {
        ...
        url:"http://129.151.112.171:8080/api/Client/save",
